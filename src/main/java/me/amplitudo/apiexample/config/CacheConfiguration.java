...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, me.amplitudo.apiexample.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, me.amplitudo.apiexample.repository.UserRepository.USERS_BY_EMAIL_CACHE);
